...
public class ImportationSetupServiceTest extends AqueducteApplicationTests {
    ...
    @Autowired
    private ImportationSetupStandardService service;
    ...
    public void setUp() throws Exception {
        ...
        ImportationSetupStandard importationSetup1 = new ImportationSetupStandard();
        ...
        ImportationSetupStandard importationSetup2 = new ImportationSetupStandard();
        ...
        ImportationSetupStandard importationSetup3 = new ImportationSetupStandard();
        ...
        ImportationSetupStandard created1 = service.createOrUpdate(importationSetup1);
        ImportationSetupStandard created2 = service.createOrUpdate(importationSetup2);
        ImportationSetupStandard created3 = service.createOrUpdate(importationSetup3);
    ...
    public void findImportSetupByFilePath() throws Exception {
        List<ImportationSetupStandard> listFiltered1 = service.findByUserIdAndFilePath("user1", "//Test1.csv");
        List<ImportationSetupStandard> listFiltered2 = service.findByUserIdAndFilePath("user2", "//Test2.csv");
